...
function InterviewLink({interViewId,formData}) {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
        ...
        <div className='mt-7 bg-white p-5 rounded-lg border border-gray-200 w-full'>
            <h2 className='font-bold'>Share Via</h2>
            <div className='flex flex-wrap gap-3 mt-2'>
                <Button variant='outline' className='flex-1 min-w-[150px]'><Mail /> EMail</Button>
                <Button variant='outline' className='flex-1 min-w-[150px]'><Mail /> Slack</Button>
                <Button variant='outline' className='flex-1 min-w-[150px]'><Mail /> Whatsapp</Button>
            </div>
